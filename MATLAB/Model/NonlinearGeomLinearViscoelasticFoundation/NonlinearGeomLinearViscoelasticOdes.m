function Odes = NonlinearGeomLinearViscoelasticOdes(x, M, MOld, parameters)
...
P3Old = parameters.P3;
    ...
    function dMdS = ViscoelasticFoundationEqns(x, M)
        ...
        dr3dS = L.*gamma.*alpha;
        dn1dS = L*K.*alpha.*gamma.*(r1 - r1Old + P1Old.*(1 - dt*nu1));
        dn3dS = L*K.*alpha.*gamma.*(r3 - r3Old + P3Old.*(1 - dt*nu3));
...
Odes = ViscoelasticFoundationEqns(x, M);
