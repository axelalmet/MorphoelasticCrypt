function EvolveLinearMaxwellFoundationShapeWithJumpContact
...
sigma = parameters.sigma; % "Width" of Wnt gradient
...
parameters.Eb = 1 - b1.*W(initSol.x, sigma./initGamma);
...
% Remesh the problem
solMesh = [linspace(0, 1, 2*contIndexOne), ...
                linspace(1, 2, 2*length(initSol.y(1,:)) - contIndexOne)];
...
outputValues = 'jumpcontact_Eb_0p5_sigmaE_2w_simplified_initforce_nu_0p16_k_0p02_L0_0p125_currentgrowth_sigma_2w_etaK_0p16';
outputDirectory = '../../../../../../Solutions/LinearViscoelasticFoundation/Maxwell/';
