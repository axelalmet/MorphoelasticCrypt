...
Residuals = [Ml(1, 1), ... % S1(0) = 0
             ...
             Ml(2, 2) - Mr(2, 1), ... % x2(S1) = L/2 - w; contact point
             Mr(6, 1) - 0.5*pi, ... % theta1(S1) = pi/2; contact point)
             Ml(6, 2) - Mr(6, 1), ... % theta2(s1) = pi/2
             Ml(4, 2) - (Mr(4, 1) + Mr(11, 1)), ... % jump in F;
             Ml(3, 2) - Mr(3, 1), ... % y3(S2) = y2(S2)
             Ml(5, 2) - Mr(5, 1), ... % G2(S1) = G1(S2); continuity
             Ml(7, 2) - Mr(7, 1), ... % m(S2) = m(S2); continuity
             Ml(8, 2) - Mr(8, 1), ...
             Ml(9, 2) - Mr(9, 1), ...
             Ml(10, 2) - Mr(10, 1), ... % continuity
             Ml(11, 2) - Mr(11, 1), ... % continuity
             Mr(1, 2) - L, ... % S3(L) = L
             Mr(2, 2) - L, ... % x3(L) = L
             Mr(5, 2), ... G(L) = 0
             Mr(6, 2)];  % theta(L) = 0
