...
mu1Values = 0.5*L:-0.005*0.5*L:0.6*0.5*L;
mu2Values = 0.5*L:0.005*0.5*L:1.4*0.5*L;

time = 0;
numSols = length(mu1Values);
...
for i = 3:numSols
    ...
    % Solve the system.
    currentSol = bvp4c(DerivFun, BcFun, solFromData, solOptions);
...
outputValues = 'Eb_init_0_sigmaE_2w_nu_simple_init_0p16_k_0p02_L0_0p125_uni_to_bimodal_etaK_0p16';
